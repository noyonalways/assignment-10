		...
		<header  className=" py-3 shadow z-10 bg-white sticky top-0">
			<div className="mx-auto md:w-5/6 w-6/6 px-2 md:px-0">
				<nav className="flex items-center justify-between relative">
					...
					<ul
						className={`text-center rounded lg:py-0 bg-[#fff] lg:bg-inherit w-full lg:w-auto absolute duration-200 lg:static left-0 lg:flex lg:items-center lg:space-x-6 ${
