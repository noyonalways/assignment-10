        ...
        <footer className="text-gray-600 body-font bg-white">
            <div className="mx-auto w-[94%] md:w-5/6 py-5">    
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="space-y-3 p-2">
                        <h2 class="text-xl font-medium text-gray-900 tracking-widest mb-3">Quick Links
                        </h2>
                        <nav class="list-none mb-10 space-y-2">
                            ...
                            <li>
                                <Link to='/blogs' class="text-gray-600 hover:text-gray-800">Blogs</Link>
                            </li>
                            <li>
                    ...
                    <div class="space-y-3 p-2">
                    <h2 class="text-xl font-medium text-gray-900 tracking-widest mb-3">Categories
                        </h2>
                        <nav class="list-none mb-10 space-y-2">
                            <li>
                                <Link  to='/' class="text-gray-600 hover:text-gray-800" rel="noopener noreferrer">Wedding Photograpy</Link>
                            </li>
                            <li>
                                <Link  to='/' class="text-gray-600 hover:text-gray-800" rel="noopener noreferrer">Events</Link>
                            </li>
                            <li>
                                <Link  to='/' class="text-gray-600 hover:text-gray-800" rel="noopener noreferrer">Anniversay</Link>
                            </li>
                            <li>
                                <Link  to='/' class="text-gray-600 hover:text-gray-800" rel="noopener noreferrer">Birthday party</Link>
                            </li>
                            
                        </nav>
                    </div>
                    <div class="space-y-3 p-2">
                    <h2 class="text-xl font-medium text-gray-900 tracking-widest mb-3">Others
                        </h2>
                        <nav class="list-none mb-10 space-y-2">
                            <li>
                                <Link  to='/' class="text-gray-600 hover:text-gray-800" rel="noopener noreferrer">First Link</Link>
                            </li>
                            <li>
                                <Link  to='/' class="text-gray-600 hover:text-gray-800" rel="noopener noreferrer">Second Link</Link>
                            </li>
                            <li>
                                <Link  to='/' class="text-gray-600 hover:text-gray-800" rel="noopener noreferrer">Third Link</Link>
                            </li>
            ...
            <div className="border-t border-gray-200">
                ...
                <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
                    ...
                    <label for="footer-field" className="leading-7 text-sm text-gray-600">Newsletter</label>
